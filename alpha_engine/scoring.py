...
class AlphaScoringEngine:
    ...
    def _score_symbol(self, symbol_row, candles_1h, candles_15m, candles_24h, depth_rows):
        ...
        raw = {
            ...
            "volume": {"volume_24h": volume_24h, "liquidity": liquidity, "volume_growth_6h": volume_growth},
